...
ADDON_SCRIPT="https://raw.githubusercontent.com/pjona/ProxmoxVE/main/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/pjona/ProxmoxVE/main/tools/addon/dockge.sh)"
MIGRATION_EOF
