...
source <(curl -fsSL https://raw.githubusercontent.com/pjona/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/pjona/ProxmoxVE/main/ct/${service}.sh)
