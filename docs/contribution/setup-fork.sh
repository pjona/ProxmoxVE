...
# upstream   https://github.com/pjona/ProxmoxVE.git (fetch)
# upstream   https://github.com/pjona/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/pjona/ProxmoxVE"
echo ""
